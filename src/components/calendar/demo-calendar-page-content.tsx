...
/** Demo Mode Calendar - same views/dialogs as the real page, backed by the
 * demo posts store. */
export function DemoCalendarPageContent() {
    ...
    <div className="flex flex-1 flex-col gap-5 px-4 py-6 sm:px-6 lg:px-8 animate-in fade-in-0 slide-in-from-bottom-2 duration-500 ease-out">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-muted-foreground">Every draft, scheduled, published, and failed post in one view. Demo workspace.</p>
        </div>
